...
import com.vijayanix.iot.db.greendao.gen.DeviceDBDao.Properties;
...
public class DeviceDBManager implements IDeviceDBManager, ISingletonObject
{
    ...
    // Singleton Pattern
    private static DeviceDBManager instance = null;
    
    private DeviceDBManager(DaoSession daoSession)
    {
    ...
    {
        instance = new DeviceDBManager(daoSession);
    }
