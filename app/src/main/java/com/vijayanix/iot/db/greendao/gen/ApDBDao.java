...
public class ApDBDao extends AbstractDao<ApDB, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsLastSelected = new Property(4, boolean.class, "isLastSelected", false, "IS_LAST_SELECTED");
        public final static Property ConfiguredFailedCount = new Property(5, int.class, "configuredFailedCount", false, "CONFIGURED_FAILED_COUNT");
        public final static Property DeviceBssids = new Property(6, String.class, "deviceBssids", false, "DEVICE_BSSIDS");
    }
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, ApDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ApDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(ApDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(ApDB entity) {
