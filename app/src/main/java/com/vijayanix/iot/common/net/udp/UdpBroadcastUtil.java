package com.vijayanix.iot.common.net.udp;
...
public class UdpBroadcastUtil
{
     ...
     */
    private static final int IOT_APP_PORT = 4035;
    ...
    private static List<IOTAddress> __discoverDevices(String bssid)
    {
        ...
        catch (IOException e)
        {
            ...
            {
                log.error(Thread.currentThread().toString() + "##__discoverDevices throws SocketTimeoutException");
            }
            else
            {
                e.printStackTrace();
