...
public class VijSocket implements Cloneable
{
    ...
    public static VijSocket createEspSocket()
    {
        return createEspSocket(new Socket());
    }
    
    public static VijSocket createEspSocket(Socket socket)
    {
        return new VijSocket(socket);
    }
    
    private VijSocket(Socket socket)
    {
        mSocket = socket;
    }
