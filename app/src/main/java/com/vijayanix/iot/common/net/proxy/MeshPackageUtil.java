 ...
 *
 */
public class MeshPackageUtil
{

    private static final boolean DEBUG = true;
    private static final boolean USE_LOG4J = true;
    private static final Class<?> CLASS = MeshPackageUtil.class;
...
//                + SocketUtil.toHexString(newRequestBytes);
//        MeshLog.d(DEBUG, USE_LOG4J, CLASS, message);
        return __addMeshRequestPackageHeader(proto, targetBssid, requestBytes, null);
    }
    
    public static byte[] addMeshGroupRequestPackageHeader(int proto, List<String> groupBssidList, byte[] requestBytes)
    {
        String MULTIPLE_CAST_BSSID = "01:00:5e:00:00:00";
        ...
        String message =
            " addMeshGroupRequestPackageHeader() proto:" + proto + ", groupBssidList:" + groupBssidList
                + ", newRequestBytes:" + SocketUtil.toHexString(newRequestBytes);
        MeshLog.d(DEBUG, USE_LOG4J, CLASS, message);
        return newRequestBytes;
    }
