...
public class MeshNetUtil2
{
    private static final Logger log = Logger.getLogger(MeshNetUtil2.class);
    ...
    private static class MeshDevice
    {
        ...
        private MeshDevice(IOTAddress iotAddress, int childrenCount)
        {
            ...
            this.mChildrenList = new ArrayList<MeshDevice>();
        }
        ...
        public boolean equals(Object o)
        {
	        ...
	        return this.mIOTAddress.equals(other.mIOTAddress);
        }
        ...
        static class CREATOR
        {
            static MeshDevice createInstance(String bssid, InetAddress rootInetAddress, String parentBssid,
                                             DeviceType deviceTypeEnum, int childrenCount, String romVersion, int rssi, String info)
            {
                ...
                return new MeshDevice(iotAddress, childrenCount);
            }
        }
    }
    ...
    private static MeshDevice queryMeshDevice(InetAddress inetAddr, String deviceBssid)
    {
        ...
        JSONObject jsonResult = BaseApiUtil.GetForJson(uriStr, deviceBssid);
        ...
        try
        {
            ...
            DeviceType currentDeviceType = DeviceType.getEspTypeEnumByString(deviceTypeStr);
            ...
            int rssi = jsonResult.optInt("rssi", IDevice.RSSI_NULL);
            ...
            for (int i = 0; i < jsonArrayChildren.length(); ++i)
            {
                ...
                DeviceType childDeviceType = DeviceType.getEspTypeEnumByString(childDeviceTypeStr);
                ...
                int childRssi = jsonChild.optInt("rssi", IDevice.RSSI_NULL);
