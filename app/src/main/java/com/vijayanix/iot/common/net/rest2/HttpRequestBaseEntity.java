...
public class HttpRequestBaseEntity implements IHttpRequest
{
    ...
    public HttpRequestBaseEntity(String method, String uriStr, String content)
    {
        this.mMethod = method;
    ...
    public HttpRequestBaseEntity(String method, String uriStr)
    {
    ...
    {
        String method = "GET";
        String uriStr = "http://iot.vijayanix.cn/v1/device";
        ...
        try
        {
            ...
            HttpRequestBaseEntity baseEntity = new HttpRequestBaseEntity(method, uriStr, content);
