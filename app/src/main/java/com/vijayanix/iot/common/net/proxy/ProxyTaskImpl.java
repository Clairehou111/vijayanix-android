...
public class ProxyTaskImpl implements ProxyTask
{
    private final static boolean DEBUG = true;
    private static final boolean USE_LOG4J = true;
    private static final Class<?> CLASS = ProxyTaskImpl.class;
    ...
    private VijSocket mSourceSocket;
    ...
    final static ProxyTask CLOSE_PROXYTASK = new ProxyTaskImpl();
    
    private ProxyTaskImpl()
    {
    }
    
    ProxyTaskImpl(String meshHost, String meshBssid, byte[] requestBuff, int targetTimeout)
        throws UnknownHostException
    {
        MeshLog.e(DEBUG, USE_LOG4J, CLASS, "ProxyTaskImpl is created, meshBssid: " + meshBssid);
    ...
    void setSourceSocket(VijSocket socket)
    {
        ...
        throws IOException
    {
        ...
        MeshLog.i(DEBUG, USE_LOG4J, CLASS, "ProxyTaskImpl meshBssid: " + mTargetBssid + " replyResponse()");
    }
    ...
    public void replyClose()
    {
        ...
        mFinished = true;
        MeshLog.i(DEBUG, USE_LOG4J, CLASS, "ProxyTaskImpl meshBssid: " + mTargetBssid + " replyClose()");
    }
    ...
    public boolean isExpired()
    {
        ...
        return consume > (mTargetTimeout + mTaskTimeout);
    }
