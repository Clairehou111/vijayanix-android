...
public class MeshLog
{
    ...
    public static void initLog4jLevel(org.apache.log4j.Level level) {
        ...
        setLog4jLevel(MeshSocketImpl.class, level);
        setLog4jLevel(MeshSocketManager.class, level);
        setLog4jLevel(ProxyServerImpl.class, level);
        setLog4jLevel(ProxyTaskFactory.class, level);
        setLog4jLevel(ProxyTaskImpl.class, level);
        setLog4jLevel(VijSocket.class, level);
        setLog4jLevel(SocketUtil.class, level);
