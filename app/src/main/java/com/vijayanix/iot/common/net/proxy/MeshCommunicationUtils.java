...
import com.vijayanix.iot.model.http.DeviceResponseStatus;
...
public final class MeshCommunicationUtils
{
                                                 ...
                                                 JSONObject postJSON, boolean nonResponse, HeaderPair... headers)
    {
        ...
        try
        {
            ...
            if (postJSON != null)
            {
                ...
                byte[] bytes = HttpUtil.decoceJSON(postJSON).getBytes();
    ...
    {
        int port = ProxyServerImpl.getInstance().getEspProxyServerPort();
    ...
    public static JSONObject JsonPost(String url, String bssid, int serial, JSONObject postJSON, HeaderPair... headers) {
        int port  = ProxyServerImpl.getInstance().getEspProxyServerPort();
        HeaderPair jsonHeader = new HeaderPair(HEADER_PROTO_TYPE, "" + ProxyTask.M_PROTO_JSON);
