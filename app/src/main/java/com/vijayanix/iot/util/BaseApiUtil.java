...
import com.vijayanix.iot.common.net.rest2.MeshDiscoverUtil;
...
public class BaseApiUtil
{
    ...
    {
        return HttpUtil.Post(url, json, headers);
    }
    ...
    {
        HttpUtil.PostInstantly(url, json, disconnectedCallback, headers);
    }
    ...
    {
        return MeshDiscoverUtil.discoverIOTDevices();
    }
    ...
    {
        return MeshDiscoverUtil.discoverIOTDevice(bssid);
    }
