...
public final class VijStrings
{
    ...
    {
        /**
         * when some devices are added into @see IDeviceCache. after receiving the broadcast, the IUser should do
         * something relying on @see IDeviceCacheHandler, and isStateMachine=true
         * 
         */
        ...
        /**
         * when some devices are added into @see IDeviceCache. after receiving the broadcast, the IUser should do
         * something relying on @see IDeviceCacheHandler, and isStateMachine=false
         * 
         */
    ...
    public static final class Key
    {
        ...
        public static final String KEY_BEEN_LOGIN = "been_logined";
