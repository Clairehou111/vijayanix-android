...
public class MeshUtil
{
    ...
    public static String asciis2String(String ASCIIs)
    {
        ...
        {
            sb.append(__ascii2Char(Integer.parseInt(ASCIIss[i])));
        }
        return sb.toString();
    }
    ...
    public static boolean isGatewayMesh(String gateway)
    {
        ...
        else
        {
            ...
            // [2-5].255.255.xxx
	        return gateways[0].equals("2") || gateways[0].equals("3") || gateways[0].equals("4")
    ...
    {
	    if ("1a:34:56:38:90:34".equals("1A3456389034"))
        {
