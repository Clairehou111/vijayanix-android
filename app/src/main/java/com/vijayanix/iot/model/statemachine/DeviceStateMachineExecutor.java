...
/**
 * this class is used to help DeviceStateMachine execute tasks.
 * 

 * 
 */
public class DeviceStateMachineExecutor
{
    private static final Logger log = Logger.getLogger(DeviceStateMachineExecutor.class);
     ...
     */
    private DeviceStateMachineExecutor()
    {
    ...
    {
        static DeviceStateMachineExecutor instance = new DeviceStateMachineExecutor();
    }
    
    public static DeviceStateMachineExecutor getInstance()
    {
