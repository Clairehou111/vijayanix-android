...
public interface IDeviceStateMachineHandler
{
    interface ITaskBase
    {
        /**
        ...
        /**
         * submit the task to DeviceStateMachineExecutor
    ...
    ITaskActivateLocal createTaskActivateLocal(IDeviceConfigure deviceConfigure);
    
    ITaskActivateInternet createTaskActivateInternet(IDeviceConfigure deviceConfigure);
