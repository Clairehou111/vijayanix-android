...
public interface IDeviceStateMachine
{
     ...
     * @param direction @see IDeviceStateMachine.Direction
     */
    void transformState(final IDevice device, final Direction direction);
     ...
     * @param direction
     */
    void transformState(final Collection<IDevice> deviceList, final Direction direction);
}
