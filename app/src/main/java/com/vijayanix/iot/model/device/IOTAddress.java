...
public class IOTAddress implements Parcelable
{
    ...
    /**
     * the device type enum, @see DeviceType
     */
    private DeviceType mDeviceTypeEnum;
     ...
     * the device rssi
     */
    private int mRssi = IDevice.RSSI_NULL;
    ...
    public void setEspDeviceTypeEnum(DeviceType deviceTypeEnum)
    {
    ...
    public boolean equals(Object o)
    {
	    ...
	    return this.mDeviceTypeEnum == other.mDeviceTypeEnum && this.mBSSID.equals(other.mBSSID);
    }
    ...
    private IOTAddress(Parcel in) {
        ...
        mDeviceTypeEnum = DeviceType.getEspTypeEnumBySerial(in.readInt());
