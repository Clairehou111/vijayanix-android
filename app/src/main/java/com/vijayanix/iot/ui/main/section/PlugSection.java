...
public class PlugSection extends DeviceSection{


	public PlugSection(String title, List<IDevice> list, Context context) {
	...
	public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
		...
		final IDevicePlug espDevice =  (IDevicePlug)getBinderDataSorce(position);
...
//			itemHolder.powerSwitch.setChecked(espDevice.getStatusPlug().isOn());
